        ...
        <div class="custom-row-2">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="contact-form">
                    ...
                    <form class="contact-form-style" id="contact-form" action="{{ route('website.save') }}" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <input name="subjet" placeholder="Subjet*" type="text">
                            </div>
                            <div class="col-lg-12">
                                <textarea name="message" placeholder="votre Message ici *"></textarea>
                                <button class="submit" type="submit">envoyer</button>
                                <button class="submit" type="rest">annuler</button>
                            </div>
                        </div>
                    </form>
