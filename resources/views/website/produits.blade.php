                                    ...
                                    <div class="product-wrap mb-25 scroll-zoom">
                                        <div class="product-img">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{asset('images/products/'.$product->photo1)}} " alt="" width="120" height="250">
                                                <img class="hover-img" src="{{asset('images/products/'.$product->photo2)}}" alt="" width="120" height="250">
                                            </a>
